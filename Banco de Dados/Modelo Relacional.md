...
Alt 1 -> 
	Na alternativa 1 todas as relações fazem referência a chave relação pai, contemplando as entidades especializadas e mantendo as relações com a entidade pai. 
