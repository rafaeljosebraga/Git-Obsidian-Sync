...
Alt 3->
	Na alternativa 3 se continua com o mesmo algoritmo do overlap, porem o Atributo de controle(AtC) é multivalorado portanto, em função de manter a nossa variável de controle ela é levada para uma outra relação criada justamente para fazer o controle das especializações referenciando a relação pai(CEG)
