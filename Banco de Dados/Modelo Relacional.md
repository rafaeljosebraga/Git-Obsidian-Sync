...
PPdr 9->
	Essa solução resolve de forma parecida o a sobreposição especificada por um multivalorado na alternativa 1 procedimento 3, onde tornamos AtC chave pra identificar várias especializações 
