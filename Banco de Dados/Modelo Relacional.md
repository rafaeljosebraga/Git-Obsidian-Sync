...
os multivalorados podem ser uma relação com chave estrangeira referenciando a relação principal (como uma entidade fraca), o caso especial Nomes dos Pais em vermelho, que só é uma solução possivel quando este multivalorado tem u
