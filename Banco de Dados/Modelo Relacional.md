...
separamos cada tipo de atributo da tupla pelo seu valor semântico, ou tipo de informação tendo cada atributo seu domínio definido por Nome, Definição Lógica, Tipo de dado e Formato. segue o exemplo->  
...
o grau é definido pela quantidade de atributos("tipos valores"), que aquela relação suporta.
